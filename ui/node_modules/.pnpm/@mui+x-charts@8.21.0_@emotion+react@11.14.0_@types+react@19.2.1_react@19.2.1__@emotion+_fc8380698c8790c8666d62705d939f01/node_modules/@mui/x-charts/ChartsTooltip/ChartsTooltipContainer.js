...
function ChartsTooltipContainer(inProps) {
  ...
  const itemPosition = (0, _useSelector.useSelector)(store, trigger === 'item' && computedAnchor === 'node' ? _useChartInteraction.selectorChartsTooltipItemPosition : selectorReturnNull, position);
  React.useEffect(() => {
